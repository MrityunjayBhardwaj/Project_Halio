...
public class RecorderAudioActivity extends AppCompatActivity implements View.OnClickListener {

    public static int RECORD_AUDIO_REQUEST_CODE =123 ;
    private Toolbar toolbar;
    private Chronometer chronometer;
    private ImageView imageViewRecord, imageViewPlay, imageViewStop;
    private SeekBar seekBar;
//    private FloatingActionButton open_list;
...
//        open_list = (FloatingActionButton)findViewById(R.id.open_list);
...
//        if( view == open_list){
//
//            Intent intent = new Intent(this, RecodingListActivity.class);
...
//
    ...
    private void startRecording() {
        ...
        File file = new File(root.getAbsolutePath() + "/Halio/Audios");
        if (!file.exists()) {
            file.mkdirs();
        }

        fileName =  root.getAbsolutePath() + "/Halio/Audios/" + String.valueOf(System.currentTimeMillis() + ".mp3");
...
//                return true;
    ...
    public void OnClickList (View view) {
        Log.i("RListAct","inside OnClickList");
        ...
        try{
            ...
            Log.i("RListAct","unable to launch RecordingListActivity");
            e.printStackTrace();
        }
    }
