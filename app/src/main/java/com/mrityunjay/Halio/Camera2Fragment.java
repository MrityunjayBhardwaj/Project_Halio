        ...
        VerticalSlideColorPicker.OnColorChangeListener
{
    ...
    /**
     * contains the absolute path of the current image.
     */
    private static String mImageAbsPath;
    ...
    public MediaPlayer CaptureMediaPlayer = new MediaPlayer();
...
//        view.findViewById(R.id.init_sticker_icon).setOnClickListener(this);
        ...
        /* Creating Folder if it doesnt exist yet.*/
        File root     = android.os.Environment.getExternalStorageDirectory();
        String path   = root.getAbsolutePath() + "/Halio/Images";
//        String path2 = MediaStore.Images.Media.EXTERNAL_CONTENT_URI.getPath();
        img_directory = new File(path);
...
//                if(audioId == 0)audioId = R.raw.female_labra_bark;

//                    if(audioUri != null)
//                    MediaPlayer.create(getActivity(),audioUri).start();

                if (is_Start){


                try {
                    CaptureMediaPlayer.setDataSource(audioUri);
                    CaptureMediaPlayer.prepare();
                    CaptureMediaPlayer.start();
...
//                        showSnackBar("Image saved"+getActivity().getExternalFilesDir(null), Snackbar.LENGTH_SHORT);
                        showSnackBar("Image saved Halio/Images",Snackbar.LENGTH_SHORT);
                        galleryAddPic();
                    }
                    else{
...
//        );
                ...
                Uri savedImgUri = Uri.parse(savedImageURL);
...
//        );
    ...
    private class BackgroundImageRotater extends AsyncTask<Void, Integer, Integer>{
        ...
        protected Integer doInBackground(Void... voids) {
            ...
            File file = new File(img_directory.getPath(), "temp_image.jpg");
    ...
    // TODO: add the full path of the image including the file_name.jpg
    private void galleryAddPic() {
        Intent mediaScanIntent = new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE);
        File mImageFile = new File(mImageAbsPath);
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            if(mImage != null){
                ...
                mImageAbsPath = file.getAbsolutePath();
